...
export class TablesComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  createSalespieChart(): void {
    ...
    // Get the canvas element and initialize the chart
    const ctx = (
      document.getElementById("salespieChart") as HTMLCanvasElement
    ).getContext("2d");
  ...
  createBookingSourcebarChart(): void {
    ...
    const ctx = (
      document.getElementById("bookingSourcebarChart") as HTMLCanvasElement
    ).getContext("2d");
  ...
  createMaterialGroupBarChart(): void {
    ...
    const ctx = (
      document.getElementById("materialGroupbarChart") as HTMLCanvasElement
    ).getContext("2d");
  ...
  createMaterialGroup3barChart(): void {
    ...
    const ctx = (
      document.getElementById("materialGroup3barChart") as HTMLCanvasElement
    ).getContext("2d");
  ...
  createChannelbarChart(): void {
    ...
    const ctx = (
      document.getElementById("channelbarChart") as HTMLCanvasElement
    ).getContext("2d");
